...
func (_m *TransactionStorage) GetBalanceTransactions(ctx context.Context, balanceID int64, limit uint64, offset uint64, orderBy string) ([]*entity.Transaction, error) {
