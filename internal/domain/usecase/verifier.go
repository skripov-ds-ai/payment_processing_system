...
type TransactionVerificationService interface {
	...
	CompletedByID(ctx context.Context, id int64) error
}
...
func (v *VerifierUseCase) CancelTransactionByID(ctx context.Context, id int64) error {
	return v.ts.CancelByID(ctx, id)
}

func (v *VerifierUseCase) CompleteTransactionByID(ctx context.Context, id int64) error {
